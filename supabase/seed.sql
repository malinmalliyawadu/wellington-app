...
-- ============================================================
-- GUIDE LIKES
-- Note: The trigger will auto-increment the denormalized likes count on guides.
-- ============================================================
INSERT INTO guide_likes (guide_id, user_id, created_at) VALUES
  -- Best Brunch Spots (popular — 5 likes)
  ('60000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', (CURRENT_DATE - 2) + TIME '09:00:00'),
  ('60000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000005', (CURRENT_DATE - 2) + TIME '10:00:00'),
  ('60000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000003', (CURRENT_DATE - 1) + TIME '11:00:00'),
  ('60000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000008', (CURRENT_DATE - 1) + TIME '14:00:00'),
  ('60000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000004', CURRENT_DATE + TIME '08:00:00'),
  -- Wellington Coffee Trail (3 likes)
  ('60000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000002', (CURRENT_DATE - 3) + TIME '08:00:00'),
  ('60000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001', (CURRENT_DATE - 2) + TIME '09:30:00'),
  ('60000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000006', (CURRENT_DATE - 1) + TIME '15:00:00'),
  -- Craft Beer Crawl (4 likes)
  ('60000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000009', (CURRENT_DATE - 2) + TIME '20:00:00'),
  ('60000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000004', (CURRENT_DATE - 1) + TIME '18:00:00'),
  ('60000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000001', (CURRENT_DATE - 1) + TIME '19:00:00'),
  ('60000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000002', CURRENT_DATE + TIME '12:00:00'),
  -- Date Night Spots (2 likes)
  ('60000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000003', (CURRENT_DATE - 1) + TIME '20:00:00'),
  ('60000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000010', CURRENT_DATE + TIME '10:00:00'),
  -- Best Views (3 likes)
  ('60000000-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000001', (CURRENT_DATE - 2) + TIME '16:00:00'),
  ('60000000-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000003', (CURRENT_DATE - 1) + TIME '17:00:00'),
  ('60000000-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000008', CURRENT_DATE + TIME '09:00:00');

-- ============================================================
-- GUIDE COMMENTS
-- ============================================================
INSERT INTO guide_comments (id, guide_id, user_id, text, created_at) VALUES
  ('70000000-0000-0000-0000-000000000001', '60000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000005',
   'Saving this for the weekend! Any of these do good eggs benny?', (CURRENT_DATE - 2) + TIME '10:30:00'),
  ('70000000-0000-0000-0000-000000000002', '60000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000002',
   'Egmont St Deli does a great one! Go early to beat the queue.', (CURRENT_DATE - 2) + TIME '11:00:00'),
  ('70000000-0000-0000-0000-000000000003', '60000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001',
   'This is exactly what I needed. Working my way through these!', (CURRENT_DATE - 2) + TIME '09:30:00'),
  ('70000000-0000-0000-0000-000000000004', '60000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000002',
   'You missed Lamason Brew Bar! Their espresso is incredible.', (CURRENT_DATE - 1) + TIME '08:00:00'),
  ('70000000-0000-0000-0000-000000000005', '60000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000009',
   'Did this last Friday. Can confirm — Hashigo Zake is the highlight.', (CURRENT_DATE - 1) + TIME '21:00:00'),
  ('70000000-0000-0000-0000-000000000006', '60000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000004',
   'Would add Fortune Favours to this list!', (CURRENT_DATE - 1) + TIME '22:00:00'),
  ('70000000-0000-0000-0000-000000000007', '60000000-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000003',
   'Mt Vic at golden hour is unbeatable. Great guide!', (CURRENT_DATE - 1) + TIME '17:30:00');
